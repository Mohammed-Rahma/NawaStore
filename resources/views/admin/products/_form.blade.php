...
<div class="row">
    <div class="col-md-8">
        <div class="mb-3">
            ...
            <div>
                <input type="text" class="form-control  @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $product->name) }}" placeholder="Name">
                @error('name')
        ...
        <div class="form-floating mb-3">
            ...
            <div>
                <textarea type="text" class="form-control @error('short_description') is-invalid @enderror" id="short_description" name="short_description" placeholder="short_description">{{ old('short_description', $product->short_description) }} </textarea>
    ...
    <div class="col-md-4">
        ...
        <div class="mb-3">
            ...
            <div>
                <select type="text" class="form-control @error('category_id') is-invalid @enderror" id="category_id" name="category_id" placeholder="category_id">
                    <option></option>
        ...
        <div class="form-floating mb-3">
            ...
            <div>
                <input type="number" step="0.1" min="0" class="form-control @error('price') is-invalid @enderror" id="price" name="price" value="{{ old('price', $product->price) }}" placeholder="price">
                @error('price')
                <p class="text-danger">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="form-floating mb-3">
            ...
            <div>
                <input type="number" step="0.1" min="0" class="form-control @error('compare_price') is-invalid @enderror" id="compare_price" name="compare_price" value="{{ old('compare_price', $product->compare_price) }}" placeholder="compare_price">
                @error('compare_price')
                <p class="text-danger">{{ $message }}</p>
                @enderror
            </div>
